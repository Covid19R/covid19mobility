...
The next thing we are going to do is we're going to call shape files for the US states and counties. We get this from the [urbnmapr](https://github.com/UrbanInstitute/urbnmapr) package. We need to also call the [sf package](https://cran.r-project.org/web/packages/sf/index.html) because we are working with shapefiles.

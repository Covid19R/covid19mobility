...
vignette: >
  %\VignetteIndexEntry{apple_cities_across_space_and_change}
...
To turn it into something sptial, we'll need to join it with the UN LOCODE classification, filter out missing spatial info, and then transform it, using as our Coordinate Reference System [EPSG 4326](https://spatialreference.org/ref/epsg/wgs-84/).
...
Let's look at the Feburary to April change first
